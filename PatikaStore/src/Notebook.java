...
public class Notebook extends Product implements Operation{
    ...
    static{
        notebookList.add(new Notebook( "Huawei Matebook 14", 7000.0, 10, 50, "Huawei", "14.0", 16,"512 GB" ));
        notebookList.add(new Notebook( "Lenovo V14 IGL", 3699.0, 10, 50, "Lenovo", "14.0", 8,"1024 GB" ));
        notebookList.add(new Notebook( "Asus Tuf Gaming", 8199.0, 10, 50, "Asus", "15.6", 32,"2048 GB" ));
    }
